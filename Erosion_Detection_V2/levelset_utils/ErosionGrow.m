function phi = ErosionGrow(vol_0, vol, mu, lambda, alpha, epsilon, timestep, iter)

% Input:
%   vol_0: intial possible erosion
%   vol: the orginal binary mask for erosion
%   g: 3D surface indicator function
%   mu: weight of the distance regularization term
%   lambda: weight of the weighted length term 
%   alpha: weight of the area term
